...
export default function IntroductionSection({ contactSectionRef }: Prop) {
  ...
  return (
    <div>
      <div className="flex gap-8 center dark:text-white">
        <div className=" flex flex-col justify-around">
          <div className="text-5xl font-extrabold">
            Hello, I am Rakshit Mehta
          </div>
          <div className="flex flex-col gap-10 text-lg my-12">
            <p>
      ...
      <button
        className="flex justify-center items-center gap-4 font-bold text-3xl font-mono border-b-2 my-10 hover:gap-10 border-transparent hover:border-black hover:dark:border-white transition-all"
